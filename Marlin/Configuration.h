...
#define STRING_CONFIG_H_AUTHOR "(just-trey, EvilGremlin, lalamapaka)" // Who made the changes.
...
#else
  #define DEFAULT_MAX_FEEDRATE          { 350, 350, 50, 70 }
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 47.5, -7, -1.258 }
 ...
 */
#define Z_PROBE_END_SCRIPT "G0 X113 F9000\nG0 Y113 F9000\nG0 Z15 F900"
...
#define HOMING_FEEDRATE_MM_M { (150*60), (150*60), (17*60) }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE 175   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
